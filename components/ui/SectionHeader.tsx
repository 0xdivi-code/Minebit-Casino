...
export default function SectionHeader({ icon, title, count, viewAllHref = "#", nav }: SectionHeaderProps) {
  return (
    <div className="mb-4 flex items-center gap-2">
      <span className="flex h-5 w-5 items-center justify-center text-muted-blue [&>svg]:h-5 [&>svg]:w-5">
        {icon}
      </span>
